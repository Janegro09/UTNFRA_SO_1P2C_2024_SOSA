...
#cambio permisos para poder escribir
sudo chmod -R 775 $RUTA/* 

sudo -u p1c2_2024_A1 bash -c "whoami > $RUTA/alumno_1/validar.txt"
sudo -u p1c2_2024_A2 bash -c "whoami > $RUTA/alumno_2/validar.txt"
sudo -u p1c2_2024_A3 bash -c "whoami > $RUTA/alumno_3/validar.txt"
sudo -u p1c2_2024_P1 bash -c "whoami > $RUTA/profesores/validar.txt"
